          ...
          >
            <div>
              <div className="flex items-center gap-2 mb-4">
                <div className="h-0.5 w-12 bg-[#0047AB]"></div>
                <span className="text-[#0047AB] font-bold tracking-wider text-sm uppercase">{currentData.label}</span>
              </div>
              <h2
                className="text-4xl md:text-5xl lg:text-5xl font-bold text-gray-900 leading-tight mb-6"
              >
                {currentData.title}
              </h2>
            </div>
